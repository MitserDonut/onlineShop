...
<div class="container-fluid">
	<div class="col-md-4">
		<a href="${ pageContext.request.contextPath}/product?method=index"><img src="img/logo.png" /></a>
	</div>
	<div class="col-md-5">
			...
			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				<ul class="nav navbar-nav">
					<c:forEach items="${sessionScope.categories}" var="category">
						<li><a href="${pageContext.request.contextPath}/product?method=product_list&cid=${category.cid}">${category.cname }</a></li>
					</c:forEach>
				</ul>
