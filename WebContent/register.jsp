...
function checkcode(){
	document.getElementById("img").src="checkcode?r="+new Date().getTime();
}
</script>
<script type="text/javascript">
	//自定义校验规则检测用户名是否存在
	...
	<div class="container"
		...
		<div class="row">
			...
			<div class="col-md-8"
				...
				<form id="registForm"   class="form-horizontal" style="margin-top: 5px;" method="post" action="${pageContext.request.contextPath}/user">
