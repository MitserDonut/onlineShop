		...
		<div class="container-fluid">
			...
			<div class="container-fluid">
				...
				<div class="col-md-2" style="border:1px solid #E7E7E7;border-right:0;padding:0;">
					<img src="products/hao/big01.jpg" width="260" height="404" style="display: inline-block;"/>
				</div>
				<div class="col-md-10">
					...
					<div class="col-md-2" style="text-align:center;height:200px;padding:10px 0px;"><!-- 点击最热商品进入其详细信息 -->
						<a href="${pageContext.request.contextPath}/product?method=productInfo&pid=${product.pid}&currentPage=${pageBean.currentPage}&cid=${cid}">
			...
			<div class="container-fluid">
				...
				<div class="col-md-10">
					...
					<div class="col-md-2" style="text-align:center;height:200px;padding:10px 0px;">
						...
						<p>
							<a href="${pageContext.request.contextPath}/product?method=productInfo&pid=${product.pid}&currentPage=${pageBean.currentPage}&cid=${cid}"
							 style='color:#666'>${product.pname}</a>
						 </p>
						<p><font color="#E4393C" style="font-size:16px">&yen;${product.shop_price}</font></p>
